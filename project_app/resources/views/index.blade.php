...
<div class="super_container">
					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								<li class="main_nav_item active"><a href="{{asset('travel')}}">Trang chủ</a></li>
					...
					<div class="top_item">
						<a href="#">
							...
							<div class="top_item_content">
								<div class="top_item_price">{{$travel->cost_tour[0]}}</div>
								<div class="top_item_text">{{$travel->name_tour[0]}}</div>
							</div>
						</a>
					</div>
				</div>
	...
	<div class="popular" style="margin-bottom: 30px">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h2>Du lịch trong nuoc</h2>
						<div>take a look at these offers</div>
					</div>
				</div>
			</div>
