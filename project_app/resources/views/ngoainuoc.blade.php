...
<html lang="en">
<head>
<title>Ngoài nước</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Destino project">
<base href="{{asset('public/destino')}}/">
					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								<li class="main_nav_item"><a href="{{asset('travel')}}">Trang chủ</a></li>
								<li class="main_nav_item"><a href="{{asset('travel/trongnuoc')}}">Trong nước</a></li>
								<li class="main_nav_item active"><a href="{{asset('travel/ngoainuoc')}}">Ngoài nước</a></li>
			...
			<div class="row">
				<div class="col">
					<div class="items item_grid clearfix">
						...
						<!-- Item -->
						<div class="item clearfix rating_3 col-6">
							<div class="item_image"><img src="images/top_2.jpg" alt=""></div>
							<div class="item_content">
								<div class="item_price">From cost tour</div>
								<div class="item_title">Name tour</div>
								<ul>
									<li>start date</li>
									<li>number date</li>
								<li>number date</li>
								...
								<div class="item_text">type tour</div>
								<div class="item_more_link"><a href="#">url tour</a></div>
							</div>
						</div>

						<!-- Item -->
						<div class="item clearfix rating_4 col-6">
